import { goal } from '../../data/solution';
                  ...
                  <div className="row">
                   ...
                   <div className="goal_section_right col-12 col-sm-12 col-md-6 col-lg-6 col-xxl-6 order-1  order-sm-1 order-md-2 order-lg-2 order-xl-2 order-xx1-2">
                    <div className="goal_floating_images_left" data-aos="laying-left-spring" data-aos-duration="1000" >
                        <img className="parent_image img-fluid" src={require(`../../images/goal_section/${goal.images.image1}`)} alt="" srcSet=""/>
                        <img className="left_children_image" src={require(`../../images/goal_section/${goal.images.image2}`)} alt="" srcSet=""/>
                        <img className="right_children_image" src={require(`../../images/goal_section/${goal.images.image3}`)} alt="" srcSet=""/>
                      </div>
                   </div>
                </div>
                </div>
